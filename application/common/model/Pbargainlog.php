...
class Pbargainlog extends Model {
     ...
     * @return type
     */
    public function getPbargainlogList($condition, $page = '',$order='pbargainlog_id desc') {
        $res = db('pbargainlog')->where($condition)->order($order)->paginate($page, false, ['query' => request()->param()]);
