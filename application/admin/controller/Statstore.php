...
class Statstore extends AdminControl
{
    ...
    public function newstore(){
        ...
        if (input('param.exporttype') == 'excel'){
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('add_store_statis'),CHARSET).date('Y-m-d-H',time()));
            exit();
        } else {
            //得到统计图数据
    ...
    public function showstore(){
        ...
        if (input('exporttype') == 'excel'){
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('ds_new').lang('ds_store'),CHARSET).date('Y-m-d-H',time()));
            exit();
        }
    ...
    public function storesales_list(){
        ...
        if (isset($this->search_arr['exporttype'])&&$this->search_arr['exporttype'] == 'excel'){
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('store_sale_statis'),CHARSET).date('Y-m-d-H',time()));
            exit();
        }
