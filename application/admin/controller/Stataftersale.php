...
class Stataftersale extends AdminControl
{
    ...
    public function refundlist(){
        ...
        if (isset($this->search_arr['exporttype']) && $this->search_arr['exporttype'] == 'excel'){
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('refund_log'),CHARSET).date('Y-m-d-H',time()));
            exit();
        } else {
    ...
    public function evalstore(){
        ...
        if (isset($this->search_arr['exporttype']) && $this->search_arr['exporttype'] == 'excel'){
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('store_dynamic_score_statis'),CHARSET).date('Y-m-d-H',time()));
            exit();
        }
        $this->assign('statlist',$statlist);
