...
class Stattrade extends AdminControl {
    ...
    public function income() {
        ...
        if (input('param.exporttype') == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('store_commis_statis'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        } else {
            //获取平台总数据
    ...
    public function predeposit() {
        ...
        if (input('param.exporttype') == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('predeposit_statis'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        } else {
    ...
    public function sale() {
        ...
        if (input('param.exporttype') == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('stat_sale'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        } else {
            //总数统计
