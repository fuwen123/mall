 ...
 * 卖家消息控制器
 */
class SellerMessage extends MobileSeller {
    ...
    /**
     * @api {POST} api/SellerMessage/get_list 消息列表
     * @apiVersion 1.0.0
     * @apiGroup SellerMessage
     *
    ...
    public function get_list() {
        ...
        if (!$this->seller_info['is_admin']) {
            $where['storemt_code'] = array('in', $this->seller_group_info['smt_limits']);
        }
