 ...
 * 卖家聊天控制器
 */
class Sellerchat extends MobileSeller {
    ...
    /**
     * @api {POST} api/Sellerchat/get_node_info node连接参数
     * @apiVersion 1.0.0
     * @apiGroup Sellerchat
     *
     ...
     * @apiSuccess {Object} result.chat_goods  商品 （返回字段参考goods表）
    ...
    /**
     * @api {POST} api/Sellerchat/get_user_list 最近联系人
     * @apiVersion 1.0.0
     * @apiGroup Sellerchat
     *
     * @apiHeader {String} X-DS-KEY 卖家授权token
    ...
    /**
     * @api {POST} api/Sellerchat/send_msg 发消息
     * @apiVersion 1.0.0
     * @apiGroup Sellerchat
     *
     * @apiHeader {String} X-DS-KEY 卖家授权token
    ...
    public function send_msg(){
        ...
        if ($msg['t_msg'] != '') $chat_msg = $webchat_model->addChatmsg($msg);
        if ($chat_msg['m_id']) {
    ...
    /**
     * @api {POST} api/Sellerchat/get_chat_log 聊天记录查询
     * @apiVersion 1.0.0
     * @apiGroup Sellerchat
     *
     * @apiHeader {String} X-DS-KEY 卖家授权token
...
//            $condition_sql = " chatlog_addtime >= '".$time_from[$key]."' ";
            ...
            $total_page = $webchat_model->page_info;
            $result = array_merge(array('list' => $list), mobile_page($total_page));
            ds_json_encode(10000, '',$result);
//        }
    }
