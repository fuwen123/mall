...
class Statmember extends AdminControl {
    ...
    public function newmember() {
        ...
        if (input('param.exporttype') == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('add_member_statis'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        } else {
            //得到统计图数据
    ...
    public function analyzeinfo() {
        ...
        if (input('param.exporttype') == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('ds_member') . $caption . lang('ds_stat'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        } else {
    ...
    public function showmember() {
        ...
        if (isset($this->search_arr['exporttype']) && $this->search_arr['exporttype'] == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('stat_newmember'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        }
    ...
    public function scale() {
        ...
        if (isset($this->search_arr['exporttype']) && $this->search_arr['exporttype'] == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('stat_scaleanalyze'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        }
        $this->assign('statlist', $statlist);
        $this->assign('show_page', $stat_model->page_info->render());
    ...
    public function area_list() {
        ...
        if (isset($this->search_arr['exporttype']) && $this->search_arr['exporttype'] == 'excel') {
            ...
            $excel_obj->generateXML($excel_obj->charset(lang('stat_areaanalyze'), CHARSET) . date('Y-m-d-H', time()));
            exit();
        }
        $this->assign('statlist', $statlist);
