      ...
      children: [
        {
          ...
          meta: { footer: { show: false }, head: { title: '用户登录', showBack: false, show: false, back: -1 } }
        },
        {
          path: 'memberregister',
          ...
          meta: {
            keepAlive: true,
            footer: { show: false },
            head: { title: '用户注册', showBack: true, show: true, back: 'goBack' }
          }
        },
        {
          path: 'document',
          ...
          meta: { footer: { show: false }, head: { title: '注册协议', showBack: true, show: true, back: -1 } }
        },
        // 还没用上的页面
        {
          path: 'index',
