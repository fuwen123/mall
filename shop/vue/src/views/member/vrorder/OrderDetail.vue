...
export default {
  ...
  methods: {
    showQrcode (vr_code) {
      MessageBox({
        title: '兑换码' + vr_code,
        message: '<div class="common-alert-content"><img src="'+env.SITE_URL+'/home/qrcode?url='+encodeURIComponent(process.envH5_HOST+'/seller/vrorder_list?vr_code='+vr_code)+'"><div class="alert-notice">请让卖家扫码或者输入兑换码进行核销</div></div>',
