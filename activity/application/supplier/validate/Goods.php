...
class Goods extends Validate
{
    ...
    protected $rule = [
        ...
        'cat_id'                 => 'number|gt:0',
        //'cat_id_2'             => 'number|gt:0',
        //'cat_id_3'             => 'number|gt:0',
        'goods_sn'               => 'unique:goods|max:20',
        //'shop_price'           => ['require', 'regex' => '([1-9]\d*(\.\d*[1-9])?)|(0\.\d*[1-9])','checkShopPrice'],
    ...
    protected $message = [
        ...
        'cat_id.gt'                                 => '商品分类必须选择',
        //'cat_id_2.gt'                             => '商品二级分类必须选择',
        //'cat_id_3.gt'                             => '商品三级分类必须选择',
    ...
    protected function checkBespeakTemplate($value, $rule, $data)
    {
