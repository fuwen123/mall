...
class Uploadify extends Base{
    ...
    public function upload(){
        ...
        $fileType = I('fileType','Images');  //上传文件类型，视频，图片
         switch ($fileType)  {
             case 'Flash':
                 $upload = U('Supplier/Ueditor/videoUp',array('savepath'=>$path,'pictitle'=>'banner','dir'=>'video'));
                 $type = 'mp4,3gp,flv,avi,wmv';
                 break;
             default:
                 $upload = U('Supplier/Ueditor/imageUp',array('savepath'=>$path,'pictitle'=>'banner','dir'=>'images'));
        ...
        $info = array(
            ...
            'title' => '',
            'upload' =>$upload,
        	'fileList'=>U('Supplier/Uploadify/fileList',array('path'=>$path)),
