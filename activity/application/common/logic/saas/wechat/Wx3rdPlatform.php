...
class Wx3rdPlatform extends WxCommon
{
     ...
     * 第三方平台代公众号申请开放平台账号
     */
    public function createWx3rdOpen($appid = '' , $accessToken = ''){
        //         $accessToken = $this->getComponentAccessToken();
        //         if (!$accessToken) {
        //             return false;
        //         }
     ...
     * 第三方平台代公众号绑定开放平台账号
     */
    public function bindWx3rdOpen($appid = '' ,$open_appid = '', $accessToken = ''){
        //         $accessToken = $this->getComponentAccessToken();
        //         if (!$accessToken) {
        //             return false;
        //         }
     ...
     * 第三方平台代公众号解绑开放平台账号
     */
    public function unbindWx3rdOpen($appid = '' ,$open_appid = '', $accessToken = ''){
        //         $accessToken = $this->getComponentAccessToken();
        //         if (!$accessToken) {
        //             return false;
        //         }
