...
class UserAddress extends Model {
    ...
    public function setLongitudeAttr($value, $data)
    {
        ...
        $query .= $data['address'];
        $ak = tpCache('basic.bd_serverak'); //iR2qhnXd5vrFI9wUuIRG9AWGIqykVNok
        $address_url = "http://api.map.baidu.com/place/v2/search?query=".$query."&region=".$region."&output=json&ak={$ak}&page_size=1&page_num=1";
