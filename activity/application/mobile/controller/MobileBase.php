...
//        Session::start();
        ...
        //微信浏览器  由于小程序终端代理引擎会出现MicroMessenger，所以不允许['miniProgram','miniprogram' ,'webview']的出现触发公众号授权
        if(strstr($_SERVER['HTTP_USER_AGENT'],'MicroMessenger') && !strstr($_SERVER['HTTP_USER_AGENT'],'miniProgram')
            && !strstr($_SERVER['HTTP_USER_AGENT'],'miniprogram') && !strstr($_SERVER['HTTP_USER_AGENT'],'webview')){
